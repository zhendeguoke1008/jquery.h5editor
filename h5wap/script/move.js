    ...
    //function newMenuMove(){
        ...
        $(".moveable-el").each(function(){
            $(this).mousedown(function (event){
                ...
                theDiv.attr("class","el-dash menu-tag");
                // 创建新元素 插入拖拽元素之前的位置(虚线框)
                $("<div class='dash menu-tag'></div>").insertBefore(theDiv);
        ...
        $(document).mousemove(function(event) {
            ...
            var  $main = $('.moveable-el'); // 局部变量：按照重新排列过的顺序  再次获取 各个元素的坐标，
        	...
        	//拉到了删除线
        	if(event.pageY > $("#menu-drop-line").offset().top){
        		theDiv.remove();
            ...
            theDiv.attr("class", "moveable-el menu-tag"); //恢复对象的初始样式
